...
%\begin{figure}[H]
%	\centering
%	\includegraphics[width=10cm]{./diagrammi/framework.png}
%	\caption{Componente Framework}
%\end{figure}
...
\setclass{TodoList::Model::ItemsStore::ListItem}
...
\textbf{Metodi:}
\begin{itemize}
	\item \method{+ListItemController()}: costruttore della classe, crea la lista recuperando i dati dall'ItemsStore;
