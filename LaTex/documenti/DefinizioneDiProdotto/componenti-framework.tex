...
\textbf{Attributi:}
\begin{itemize}
	\item \field{- children: GUI[]}: array di componenti grafici.\footnote{Nel diagramma sono preceduti da \virgolette{>>} i tipi appartenenti ad un sotto-package rispetto a quello attuale, indicandone quindi il percorso relativo.}
\end{itemize}
