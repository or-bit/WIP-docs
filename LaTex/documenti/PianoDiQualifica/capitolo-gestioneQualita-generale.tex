...
Inoltre, perché il sistema prodotto sia conforme a quanto stabilito, vengono attuati processi di validazione.\\
...
Per definire e controllare i processi si è deciso di basarsi sulle norme \textbf{ISO 9000} descritte in \sezione{sec:iso9000} del presente documento.\\
...
Per utilizzare questo strumento è necessario dotarsi di una disciplina di miglioramento dei processi, realizzata attraverso il ciclo di Deming, definito in \appendice{app:pdca}.
...
\begin{itemize}
	...
	\item \textbf{Verifica}: determina la correttezza dei risultati. È un’attività continuativa durante lo svolgimento del progetto. Ad ogni verifica vengono riportati i risultati in \appendice{app:risultati _verifica};
