...
\begin{longtable}{|c|P{9cm}|P{2.5cm}|}
	...
	\hline \test{V}{L99} & L'utente chef intende visualizzare la lista delle ordinazioni attive e per ognuna visulizzare il nome dei piatti ed il rispettivo ammontare quindi seleziona l'ordinazione una volta completata. L'utente :
	\begin{itemize}
	...
	\hline \test{V}{L100} & L'utente amministratore intende visualizzare il menu del ristorante consultando i piatti ed i prezzi. In questa sezione può: rimuovere,modificare oppure aggiungere un piatto.
	...
	\hline \test{V}{L101} & L'utente amministratore intende visualizzare la lista delle ordinazioni e consultare quali sono attive e quali completate con i dati relativi al cliente. Inoltre avrà la possibilità di rimuovere le ordinazioni. L'utente :
	\begin{itemize}
