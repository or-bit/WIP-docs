...
\begin{longtable}{|c|P{9cm}|c|}
	...
	\end{itemize}
	 \\
	\hline \test{U}\label{tu-checkboxgroup} & Verifica che il componente CheckBoxGroup: renderizzi correttamente  \\
	\hline \test{U}\label{tu-image} & Verifica che il componente Image renderizzi correttamente	 \\
	\hline \test{U}\label{tu-inputfile} & Verifica che l'InputFile sia sia formato in modo corretto  \\
	\hline \test{U} & Verifica che il componente InputText sia formato in modo corretto  \\
	...
	\end{itemize}
	 \\
	\hline \test{U} & Verifica che il componente GUIContainer venga renderizzato correttamente  \\
	\hline
...
\begin{longtable}{|c|P{9cm}|c|}
	...
	\end{itemize}
	 \\
	\hline \test{U} & Verifica che il Controller renderizzi correttamente  \\
	\hline \test{U} & Verifica che la View renderizzi correttamente  \\
	\hline
...
\begin{longtable}{|c|P{9cm}|c|}
	...
	\end{itemize}
	 ...
	 \end{itemize}
 	 \\
	\hline\test{U}\label{tu-json} & Verifica che l'oggetto JSON dedicato alla connessione sia formattato in modo corretta  \\
...
%	\hline\test{U} & Verifica che le istanze di tipo Actions della presenza e dell'assenza del cook sono generate in modo corretto & Superato \\
	\hline\test{U} & Verifica che le chiamate di aggiunta, modifica e rimozione del menu siano generate in modo corretto \\
	\hline\test{U} & Verifica che le chiamate di aggiunta, modifica e rimozione dell'ordinazione siano generate in modo corretto \\
