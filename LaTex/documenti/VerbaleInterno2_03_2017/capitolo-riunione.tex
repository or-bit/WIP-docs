...
VI_2017-03-2_D2: Si è deciso di considerare le parte delle \glossario{bubble} già presenti nel \glossario{framework} come direttamente collegate al \glossario{framework} e non di esclusiva competenza di ciascuna \glossario{bubble}, con conseguenze nelle descrizioni e nei grafici relativi ad esse.

\subsubsection{Immagini progetto Visual Paradigm}
VI_2017-03-2_D3: Si è deciso di gestire le immagini all'interno di un progetto unico di \glossario{Visual Paradigm} in modo da poter controllarne esportazione e modifica in modo più semplice e diretto.
