...
\definizione{GUI}
GUI acronimo per Graphical User Interface è il termine per definire l'interfaccia grafica utente che permette all'utente di interagire con l'applicazione.
\clearpage
