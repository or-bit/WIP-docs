...
La bubble memory è un oggetto \glossario{javascript} in cui viene salvato lo stato della bolla e di eventuali variabili utilizzate per tenere traccia dello stato delle componenti di input/output.La durata di questa memoria è uguale alla durata della bolla stessa.
