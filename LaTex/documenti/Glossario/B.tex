...
La bubble memory è un oggetto \glossario{javascript} in cui viene salvato lo stato della bolla e di eventuali variabili utilizzate per tenere traccia dello stato degli \gloassario{elementi di input} e \glossario{elementi di output}.La durata di questa memoria è uguale alla durata della bubble stessa.
