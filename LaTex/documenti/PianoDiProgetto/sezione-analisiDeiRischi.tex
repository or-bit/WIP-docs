...
\begin{enumerate}
	...
	\item \textbf{Riscontro:} 
	\begin{itemize}
		\item Analisi dei requisiti: la preparazione personale svolta da ciasun membro del gruppo è risultata sufficiente ad evitare grossi errori nell'utilizzo dei nuovi strumenti software. I piccoli problemi che si sono verificati sono stati rapidamente corretti anche tramite la collaborazione tra i diversi membri del gruppo.
	\end{itemize}
\end{enumerate}
...
\begin{enumerate}
	...
	\item \textbf{Riscontro:}
	\begin{itemize}
	\item Analisi dei requisiti: l'inesperieza dei componenti del gruppo non ha portato a problematiche evidenti durante questo periodo del progetto.
	\end{itemize}
\end{enumerate}
