...
\item \textbf{\AD:} fase di analisi successiva all'accetazione della proposta;
\item \textbf{\PA}
\item \textbf{\PD e \Cod}
\item \textbf{\VV}
\end{itemize}
...
Tale fase inizia in corrispondenza della data di scadenza per la formazione dei gruppi e termina con la data di consegna dei documenti per la \RR. Nela fase di \AR i documenti di maggior impatto sono: \textit{Norme di progetto}, \textit{Studio di fattibilità}, \textit{Analisi dei requisiti}, \textit{Piano di qualifica}, \textit{Piano di progetto}, \textit{Glossario} e \textit{Lettera di presentazione}.
...
Tale fase inizia dopo la fase di \AD. La fase di \textbf{Progettazione architetturale} riguarda lo sviluppo dell'architettura del sistema da realizzare. I documenti che vengno incrementati in questa fase sono: \textit{Specifica Tecnica}, accompagnata da: \textit{Norme di progetto}, \textit{Piano di qualifica} e \textit{Glossario}.
