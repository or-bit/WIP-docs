...
\UC{Connessione a database MongoDB}{UC1.00}
...
\begin{itemize}
	...
	\begin{itemize}
		\item Avere già istanziato una \glossario{bubble generica};
		\item La \glossario{bubble} è connessa al database \glossario{MongoDB} \ref{UC1.00};
...
\begin{itemize}
	...
	\\L'elemento non è presente nella \glossario{bubble} \ref{UC1.03.2}.
	\item \textbf{Post-condizione:}
...
\begin{itemize}
	...
	\item \textbf{Scenari alternativi:}
	\\L'elemento è presente nella \glossario{bubble} \ref{UC1.03.1}.
	\item \textbf{Post-condizione:}
...
\begin{itemize}
	...
	\item \textbf{Scenari alternativi:}
	\\L'elemento che si vuole modificare non è presente nella \glossario{bubble} \ref{UC1.05.2}.
	\item \textbf{Post-condizione:}
...
\begin{itemize}
	...
	\item \textbf{Scenari alternativi:}
	\\L'\glossario{elemento} è presente nella \glossario{bubble} \ref{UC1.05.1}.
	\item \textbf{Post-condizione:}
...
\begin{itemize}
	...
	\item \textbf{Post-condizione:}
	\\Al termine del periodo di tempo specificato dal metodo verrà invocata la sua terminazione secondo quanto specificato nel caso d'uso \ref{UC1.19} termina \glossario{bubble}.
\end{itemize}
...
\begin{figure}[H]
	...
	\caption{\UCCaption{} Termina \glossario{bubble}}
\end{figure}
...
\begin{itemize}
	...
	\item \textbf{Scenari alternativi:}
	\\Il salvataggio del file \glossario{PDF} non ha successo \ref{UC1.20.2}.
	\item \textbf{Post-condizione:}
...
\begin{itemize}
	...
	\item \textbf{Scenari alternativi:}
	\\Il salvataggio del file \glossario{PDF} ha successo \ref{UC1.20.2}.
	\item \textbf{Post-condizione:}
...
\begin{itemize}
	...
	\item \textbf{Flusso principale degli eventi:}
	\begin{itemize}
		\item L'utente invoca il comando di creazione della \glossario{bubble} \glossario{To-do list} \ref{UC2.1.1};
...
\begin{itemize}
	...
	\begin{itemize}
		\item Essere utenti di \glossario{Rocket.Chat};
		\item Avere \ProjectName{} installato;
		\item Aver invocato il comando di creazione della \glossario{to-do list} \ref{UC2.1.1}.
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\L'utilizzatore della \glossario{bubble} inserisce i dati necessari nel form visualizzato al caso d'uso \ref{UC2.1.2}.
	\item \textbf{Post-condizione:}
	\\Nella memoria della \glossario{bubble} sono salvati i dati richiesti nel caso d'uso \ref{UC2.1.4}. 
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Flusso principale degli eventi:}
	\begin{itemize}
		\item L'utente seleziona l'opzione aggiungi \glossario{elemento} \ref{(UC2.2.1)};
...
\begin{itemize}
	...
	\begin{itemize}
		\item Avere ricevuto una \glossario{bubble} \glossario{To-do list};
		\item Avere selezionato l'opzione aggiungi \glossario{elemento} come da \ref{UC2.2.1}.
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
...
\begin{itemize}
	...
	\begin{itemize}
		\item Avere ricevuto una \glossario{bubble} \glossario{To-do list};
		\item Aver inserito le informazioni per il nuovo \glossario{elemento} secondo \ref{UC2.2.3}.
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
...
\begin{itemize}
	...
	\begin{itemize}
		\item Avere ricevuto una \glossario{bubble} \glossario{To-do list};
		\item Essere entrati nell'opzione \virgolette{aggiungi modifica} della propria \glossario{bubble} secondo \ref{UC2.4.1}.
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item La \glossario{bubble} ha caricato il form di inserimento dati secondo lo \ref{UC2.4.2}.
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\Con l'apposito comando il \glossario{Cliente} conferma che i dati precedentemente immessi al caso d'uso \ref{UC3.1.2} siano corretti.
	\item \textbf{Post-condizione:}
