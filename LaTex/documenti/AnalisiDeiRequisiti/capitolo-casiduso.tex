...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_00.png}
\end{center}
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\L’utilizzatore chiama il metodo su una bolla, il quale gli ritorna un oggetto \glossario{json} letto dal database eventualmente assegnabile ad un campo della \glossario{bubble memory}.
	\item \textbf{Post-condizione:}
	\\I dati sono prelevati dal database e sono pronti all’uso nella bubble.
\end{itemize}

\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_01.png}
\end{center}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_02.png}
\end{center}
...
\begin{itemize}
	...
	\\Utilizzatore del \glossario{framework}.
	\item \textbf{Scopo e descrizione:} 
	\\Rimuovere dalla bubble un \glossario{elemento} specificato.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una \glossario{bubble generica};
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\L’utilizzatore chiama il metodo il quale rimuove l’\glossario{elemento} dalla bubble.
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_03.png}
\end{center}
...
\begin{itemize}
	...
	\\Utilizzatore del \glossario{framework}.
	\item \textbf{Scopo e descrizione:} 
	\\Inserire nella bubble un \glossario{elemento}.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una \glossario{bubble generica};
	...
	\item \textbf{Post-condizione:}
	\\La bubble avrà al suo interno l'\glossario{elemento} passato al metodo.
\end{itemize}

\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_04.png}
\end{center}
...
\begin{itemize}
	...
	\\Utilizzatore del \glossario{framework}.
	\item \textbf{Scopo e descrizione:} 
	\\Modifica un \glossario{elemento} di una bubble.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una \glossario{bubble generica};
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\L’utilizzatore invoca il metodo sulla bubble e il metodo va a modificare l’\glossario{elemento}.
	\item \textbf{Scenari alternativi:}
	\\ L’elemento non è presente nella bubble \hyperref[UC1.05.2]{(UC1.05.2)}.
	\item \textbf{Post-condizione:}
	\\La bubble contiene l’\glossario{elemento} modificato.
\end{itemize}

\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_05.png}
\end{center}
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\L’utilizzatore invoca il metodo sulla bubble e il metodo, non trovando l’\glossario{elemento} da modificare, lancia un messaggio di errore.
	\item \textbf{Scenari alternativi:}
	\\L’\glossario{elemento} è presente nella bubble \hyperref[UC1.05.1]{(UC1.05.1)}.
	\item \textbf{Post-condizione:}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_06.png}
\end{center}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_07.png}
\end{center}
...
\begin{itemize}
	...
	\item \textbf{Post-condizione:}
	\\Il singolo utilizzatore della bubble come utente di \glossario{Rocket.Chat} non potrà’ interagire con la stessa istanza della bubble più volte di quelle specificate.
\end{itemize}

\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_08.png}
\end{center}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_09.png}
\end{center}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_10.png}
\end{center}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_11.png}
\end{center}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_12.png}
\end{center}
...
\begin{itemize}
	...
	\\Utilizzatore del \glossario{framework}.
	\item \textbf{Scopo e descrizione:} 
	\\Dare la possibilità all'utilizzatore del \glossario{framework} di impostare un limite temporale entro il cui la bubble smetterà di essere attiva.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una \glossario{bubble generica}.
	\end{itemize}
	...
	\item \textbf{Post-condizione:}
	\\Al termine del periodo di tempo specificato dal metodo verrà invocata la sua terminazione secondo quanto specificato nel \glossario{caso d'uso} \hyperref[UC1.19]{UC1.19} termina bubble.
\end{itemize}

\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_13.png}
\end{center}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_14.png}
\end{center}
...
\begin{itemize}
	...
	\\Utilizzatore del \glossario{framework}.
	\item \textbf{Scopo e descrizione:} 
	\\Dare la possibilità all'utilizzatore del \glossario{framework} di consultare lo storico delle interazioni che un singolo utente ha avuto con la bubble.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una \glossario{bubble generica};
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_15.png}
\end{center}
...
\begin{itemize}
	...
	\\Utilizzatore del \glossario{framework}.
	\item \textbf{Scopo e descrizione:} 
	\\L’utilizzatore del \glossario{framework} può fornire un orario per l’esecuzione della funzionalità della bubble.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una \glossario{bubble generica};
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_16.png}
\end{center}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_17.png}
\end{center}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_18.png}
\end{center}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_19.png}
\end{center}
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\L’utilizzatore del framework chiama il metodo specificando il testo da convertire in \glossario{pdf} e il percorso in cui si desidera salvare il file.
	\item \textbf{Scenari alternativi:}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_20.png}
\end{center}
...
\begin{itemize}
	...
	\\Utilizzatore del \glossario{framework}.
	\item \textbf{Scopo e descrizione:} 
	\\L’utilizzatore del \glossario{framework} potrà terminare la bubble.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una \glossario{bubble generica};
		\item Avere almeno un \glossario{elemento grafico} nella bubble.
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\L’utilizzatore del \glossario{framework} chiama il metodo specificando quale \glossario{elemento grafico} della bubble vuole mostrare.
	\item \textbf{Post-condizione:}
	\\L'\glossario{elemento grafico} specificato è visibile.
\end{itemize}

\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_21.png}
\end{center}
...
\begin{itemize}
	...
	\begin{itemize}
		\item Avere già istanziato una \glossario{bubble generica};
		\item Avere almeno un \glossario{elemento} nella bubble.
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\L’utilizzatore del \glossario{framework} chiama il metodo specificando quale \glossario{elemento grafico} della bubble vuole nascondere.
	\item \textbf{Post-condizione:}
	\\L'\glossario{elemento grafico} specificato non è più visibile.
\end{itemize}

\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_22.png}
\end{center}
...
\begin{itemize}
	...
	\\Utilizzatore del \glossario{framework}.
	\item \textbf{Scopo e descrizione:} 
	\\L’utilizzatore del \glossario{framework} può specificare una posizione per un \glossario{elemento grafico} della bubble.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una \glossario{bubble generica};
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_23.png}
\end{center}
...
\begin{itemize}
	...
	\\Utilizzatore del \glossario{framework}.
	\item \textbf{Scopo e descrizione:} 
	\\L’utilizzatore del \glossario{framework} può salvare l’output della bubble in un file.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una \glossario{bubble generica};
		\item Avere almeno un \glossario{elemento} nella bubble.
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\L’utilizzatore del \glossario{framework} chiama il metodo che specifica che l’output della bubble sia un file e le informazioni da salvare in esso.
	\item \textbf{Scenari alternativi:}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_24.png}
\end{center}
...
\begin{itemize}
	...
	\\Utilizzatore del \glossario{framework}.
	\item \textbf{Scopo e descrizione:} 
	\\L’utilizzatore del \glossario{framework} può salvare l’output della bubble in un file, il salvataggio non va a buon fine e viene generato un messaggio d’errore.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una \glossario{bubble generica};
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\L’utilizzatore del \glossario{framework} chiama il metodo che specifica che l’output della bubble sia un file e le informazioni da salvare in esso,  il salvataggio non va a buon fine e viene generato un messaggio d’errore.
	\item \textbf{Scenari alternativi:}
...
\begin{itemize}
	...
	\\Utilizzatore del \glossario{framework}.
	\item \textbf{Scopo e descrizione:} 
	\\L’utilizzatore del \glossario{framework} può inserire all'interno della bubble un file immagine.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una \glossario{bubble generica};
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\L’utilizzatore del \glossario{framework} chiama il metodo che specifica il file immagine da includere nella bubble.
	\item \textbf{Post-condizione:}
	\\Il file immagine è stato incluso nella bubble.
\end{itemize}

\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_25.png}
\end{center}
...
\begin{itemize}
	...
	\\Utilizzatore del \glossario{framework}.
	\item \textbf{Scopo e descrizione:} 
	\\L’utilizzatore del \glossario{framework} può inserire all'interno della bubble una \glossario{TextView}.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una \glossario{bubble generica};
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\L’utilizzatore del \glossario{framework} chiama il metodo che specifica il testo da includere nella bubble.
	\item \textbf{Post-condizione:}
	\\Il testo è stato incluso nella bubble.
\end{itemize}

\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_26.png}
\end{center}
...
\begin{itemize}
	...
	\\Utilizzatore del \glossario{framework}.
	\item \textbf{Scopo e descrizione:} 
	\\L’utilizzatore del \glossario{framework} può inserire all'interno della bubble una \glossario{label}.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una \glossario{bubble generica};
		\item Avere un testo da visualizzare.
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_27.png}
\end{center}
...
\begin{itemize}
	...
	\\Utilizzatore del \glossario{framework}.
	\item \textbf{Scopo e descrizione:} 
	\\L’utilizzatore del \glossario{framework} può inserire all'interno della bubble un grafico a torta.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una \glossario{bubble generica};
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\L’utilizzatore del \glossario{\glossario{framework}} chiama il metodo specificando i dati da rappresentare nel grafico a torta.
	\item \textbf{Post-condizione:}
	\\I dati sono rappresentati nel grafico a torta. Il grafico è visualizzato nella bubble.
\end{itemize}

\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_28.png}
\end{center}
...
\begin{itemize}
	...
	\\Utilizzatore del \glossario{framework}.
	\item \textbf{Scopo e descrizione:} 
	\\L’utilizzatore del \glossario{framework} può inserire all'interno della bubble un grafico istogramma.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una \glossario{bubble generica};
		\item Essere in possesso dei dati che si desidera visualizzare nel grafico.
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\L’utilizzatore del \glossario{\glossario{framework}} chiama il metodo specificando i dati da rappresentare nel grafico istogramma.
	\item \textbf{Post-condizione:}
	\\I dati sono rappresentati nel grafico a istogramma. Il grafico è visualizzato nella bubble.
\end{itemize}

\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_29.png}
\end{center}
...
\begin{itemize}
	...
	\\Utilizzatore del \glossario{framework}.
	\item \textbf{Scopo e descrizione:} 
	\\L’utilizzatore del \glossario{framework} può inserire un \glossario{elemento} \glossario{checkbox} all’interno della bubble specificando la variabile della \glossario{bubble memory} a cui l'\glossario{elemento} è assegnato.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una \glossario{bubble generica}.
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\L’utilizzatore del \glossario{\glossario{framework}} chiama il metodo per aggiungere alla bubble una \glossario{checkbox} relativa ad un \glossario{elemento} della \glossario{bubble memory} specificato.
	\item \textbf{Post-condizione:}
	\\Nella bubble è presente la \glossario{checkbox}, nella \glossario{bubble memory} è presente la variabile a cui è assegnata.
\end{itemize}

\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_30.png}
\end{center}
...
\begin{itemize}
	...
	\\Utilizzatore del \glossario{framework}.
	\item \textbf{Scopo e descrizione:} 
	\\L’utilizzatore del \glossario{\glossario{framework}} può inserire un \glossario{elemento} \glossario{bottone radio} di scelta di un \glossario{elemento} tra molti all’interno della bubble specificando la variabile della \glossario{bubble memory} a cui la scelta è assegnata.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una \glossario{bubble generica}.
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\L’utilizzatore del \glossario{\glossario{framework}} chiama il metodo per aggiungere alla bubble un \glossario{bottone radio} relativo ad un \glossario{elemento} della \glossario{bubble memory} specificato.
	\item \textbf{Post-condizione:}
	\\Nella bubble è presente il radiobutton, nella \glossario{bubble memory} è presente la variabile a cui è assegnata.
\end{itemize}

\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_31.png}
\end{center}
...
\begin{itemize}
	...
	\\Utilizzatore del \glossario{framework}.
	\item \textbf{Scopo e descrizione:} 
	\\L’utilizzatore del \glossario{framework} può inserire un \glossario{elemento} \glossario{bottone} all’interno della bubble specificando la funzione che verrà eseguita alla pressione del \glossario{bottone} da parte dell’utente.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una \glossario{bubble generica};
	...
	\item \textbf{Post-condizione:}
	\\Nella bubble è presente il \glossario{bottone}. Alla pressione da parte dell'utente della bubble la funzione di \glossario{callback} specificata verrà eseguita.
\end{itemize}

\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_32.png}
\end{center}
...
\begin{itemize}
	...
	\item \textbf{Post-condizione:}
	\\Nella bubble è presente il \glossario{bottone}. Nella \glossario{bubble memory} è presente il valore attuale del testo presente nell’\glossario{elemento} della bubble.
\end{itemize}

\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_33.png}
\end{center}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_34.png}
\end{center}
...
\begin{itemize}
	...
	\\Utilizzatore del \glossario{framework}.
	\item \textbf{Scopo e descrizione:} 
	\\L’utilizzatore del \glossario{framework} può istanziare il contenitore \glossario{bubble generica}, la quale funge da contenitore dei vari elementi di input, output e di logica specificati all'interno del \glossario{framework}.
	\item \textbf{Flusso principale degli eventi:}
	\\L’utilizzatore del \glossario{framework} chiama il metodo istanziare la \glossario{bubble generica} e la memoria ad essa associata.
	\item \textbf{Post-condizione:}
	\\É presente la \glossario{bubble generica}, e la sua memoria.
\end{itemize}

\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_35.png}
\end{center}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_36.png}
\end{center}
...
\begin{itemize}
	...
	\item \textbf{Flusso principale degli eventi:}
	\begin{itemize}
		\item L’utente invoca il comando di creazione della bubble \glossario{to-do list} \hyperref[UC2.1.1]{(UC2.1.1)};
	...
	\end{itemize}
	\item \textbf{Post-condizione:}
	\\Nella conversazione è presente una bubble \glossario{to-do list} con il titolo indicato.
\end{itemize}

\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc2_1.png}
\end{center}
...
\begin{itemize}
	...
	\\Utente di \glossario{Rocket.Chat} in possesso di monolith.
	\item \textbf{Scopo e descrizione:} 
	\\Creare un \glossario{to-do list} all'interno della chat.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Essere utenti di \glossario{Rocket.Chat};
		\item Avere monolith installato;
		\item Avere accesso alla bubble \glossario{to-do list}.
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\L’utilizzatore di monolith utilizzando l'apposito comando inizia la creazione della bubble \glossario{to-do list}.
	\item \textbf{Post-condizione:}
...
\begin{itemize}
	...
	\begin{itemize}
		\item Essere utenti di \glossario{Rocket.Chat};
		\item Avere monolith installato;
		\item Aver invocato il comando di creazione di \glossario{to-do list} \hyperref[UC2.1.1]{UC2.1.1}.
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\Viene caricato il form per l’inserimento delle informazioni.
	\item \textbf{Post-condizione:}
	\\Nella conversazione è presente una bubble \glossario{to-do list} con al suo interno un form per l'inserimento delle informazioni necessarie al completamento della creazione della \glossario{to-do list}.
\end{itemize}
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\L'utilizzatore della bubble inserisce i dati necessari nel form visualizzato al \glossario{caso d'uso} \hyperref[UC2.1.2]{UC2.1.2}.
	\item \textbf{Post-condizione:}
	\\Nella memoria della bubble sono salvati i dati richiesti nel \glossario{caso d'uso} \hyperref[UC2.1.4]{UC2.1.4}. 
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere ricevuto una bubble di \glossario{to-do list};
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc2_2.png}
\end{center}
...
\begin{itemize}
	...
	\item \textbf{Post-condizione:}
	\\Il nuovo \glossario{elemento} è aggiunto alla bubble \glossario{to-do list}.
\end{itemize}
...
\begin{itemize}
	\item \textbf{Attori:}
	\\Utente di \glossario{Rocket.Chat} in possesso di monolith che abbia ricevuto come messaggio una bubble \glossario{to-do list}.
	\item \textbf{Scopo e descrizione:} 
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc2_3.png}
\end{center}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc2_4.png}
\end{center}
...
\begin{itemize}
	...
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere creato una bubble di \glossario{to-do list}.
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\La bubble \glossario{to-do list} carica il form di inserimento dati per le notifiche.
	\item \textbf{Post-condizione:}
...
\begin{itemize}
	...
	\item \textbf{Post-condizione:}
	\\La bubble possiede tutte le informazioni necessarie ad aggiungere una notifica alla \glossario{to-do list}.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Post-condizione:}
	\\La bubble ha aggiunto la notifica alla \glossario{to-do list}.
\end{itemize}
...
\\L'ordine così effettuato verrà trasmesso alla cucina del locale tramite bubble “todo list”, sotto forma di casella aggiunta automaticamente in fondo alla lista, il \glossario{Cuoco} una volta completato l'ordine avrà facoltà di segnare completata l’ordinazione dalla lista.
...
\begin{itemize}
	...
	\item \glossario{Responsabile Acquisti}: addetto a rifornire il magazzino sulla base degli ingredienti consumati dal \glossario{Cuoco} in base a quanto gli è notificato dalla sua todo list nella bubble;
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc3_1.png}
\end{center}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc3_2.png}
\end{center}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc3_3.png}
\end{center}
...
\begin{itemize}
	...
	\\\glossario{Cliente}.
	\item \textbf{Scopo e descrizione:} 
	\\Confermare che quanto mostrato nel \glossario{caso d'uso} \hyperref[UC3.3.4]{UC3.3.4} è corretto e salvare l'ordinazione nella memoria della bubble.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere \glossario{Rocket.Chat};
		\item Avere la bubble del ristorante selezionato;
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc3_4.png}
\end{center}
...
\begin{itemize}
	...
	\\\glossario{Cliente}.
	\item \textbf{Scopo e descrizione:} 
	\\Ottenere informazioni riguardanti il \glossario{Cliente} dalla memoria della bubble.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere \glossario{Rocket.Chat};
		\item Avere la bubble del ristorante selezionato;
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\Vengono recuperate le informazioni sui dati personali del \glossario{Cliente} dalla memoria della bubble.
	\item \textbf{Post-condizione:}
	\\I dati personali del \glossario{Cliente} sono stati letti dalla memoria della bubble.
\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		\item Avere \glossario{Rocket.Chat};
		\item Avere la bubble del ristorante selezionato;
		\item Avere accesso alla bubble con il ruolo di \glossario{Cuoco}.
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\begin{itemize}
		\item Il \glossario{Cuoco} seleziona la parte corrispondente della bubble;
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc3_5.png}
\end{center}
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\Il \glossario{Cuoco} richiede di visualizzare la lista dei piatti da preparare, la bubble carica la lista dal database.
	\item \textbf{Post-condizione:}
...
\begin{itemize}
	...
	\\\glossario{Cuoco}.
	\item \textbf{Scopo e descrizione:} 
	\\Lo scopo di questa funzionalità è di far visualizzare al \glossario{Cuoco} la lista dei piatti precedentemente caricata dal database sulla bubble.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere \glossario{Rocket.Chat};
		\item Avere la bubble del ristorante selezionato;
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\La bubble mostra la lista dei piatti precedentemente memorizzata al \glossario{Cuoco}.
	\item \textbf{Post-condizione:}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc3_6.png}
\end{center}
...
\begin{itemize}
	...
	\item \textbf{Flusso principale degli eventi:}
	\begin{itemize}
		\item Il \glossario{Responsabile Acquisti} seleziona la parte corrispondente della bubble;
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc3_7.png}
\end{center}
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\Il \glossario{Responsabile Acquisti} richiede di visualizzare la lista e la bubble la carica dal database.
	\item \textbf{Post-condizione:}
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\Il \glossario{Responsabile Acquisti} guarda la bubble interattiva.
	\item \textbf{Post-condizione:}
	\\Il \glossario{Responsabile Acquisti} è a conoscenza dei prodotti da acquistare.
\end{itemize}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc3_8.png}
\end{center}
...
\begin{itemize}
	...
	\begin{itemize}
		\item Avere \glossario{Rocket.Chat};
		\item Avere la bubble del ristorante selezionato;
		\item Avere accesso alla bubble con il ruolo \glossario{Fattorino}.
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\begin{itemize}
		\item Il \glossario{Fattorino} seleziona la parte corrispondente della bubble;
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc3_9.png}
\end{center}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc3_10.png}
\end{center}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc3_11.png}
\end{center}
...
\begin{itemize}
	...
	\item \textbf{Post-condizione:}
	\\Nella bubble del \glossario{Fattorino} è salvato lo stato che la consegna è stata effettuata con successo.
\end{itemize}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc3_12.png}
\end{center}
...
\begin{itemize}
	...
	\\\glossario{Direttore}.
	\item \textbf{Scopo e descrizione:} 
	\\Lo scopo di questa funzione è permettere alla bubble del \glossario{Direttore} di avere nella propria memoria la lista delle ordinazioni effettuate.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere \glossario{Rocket.Chat};
		\item Avere la bubble del ristorante selezionato;
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\Il \glossario{Direttore} consulta la bubble in modalità di cancellazione dell’ordinazione del \glossario{Cuoco}.
	\item \textbf{Post-condizione:}
	\\L’ordine è stato cancellato dalla \glossario{to-do list} del \glossario{Cuoco}.
\end{itemize}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc3_13.png}
\end{center}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc3_13_1.png}
\end{center}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc3_13_2.png}
\end{center}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc3_13_3.png}
\end{center}
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\Il \glossario{Direttore} dopo aver finito di applicare tutti i cambiamenti desiderati al menù seleziona l’opzione “Applica cambiamenti”, i cambiamenti vengono dunque memorizzati all’interno della bubble.
	\item \textbf{Post-condizione:}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc3_13_4.png}
\end{center}
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\Il \glossario{Direttore} compila il form caricato dalla bubble in tutte le sue parti.
	\item \textbf{Post-condizione:}
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc3_14.png}
\end{center}
...
\begin{itemize}
	...
	\item \textbf{Flusso principale degli eventi:}
	\begin{itemize}
		\item Il \glossario{Direttore} seleziona la parte corrispondente della bubble;
...
\begin{center}
	\includegraphics{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc3_15.png}
\end{center}
