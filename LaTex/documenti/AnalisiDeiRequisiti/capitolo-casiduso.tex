...
\subsubsection{UC2.1.1 Invocare il comando della bubble di creazione della \glossario{To-do List}} \label{UC2.1.1}
...
\begin{itemize}
	...
	\item \textbf{Post-condizione:}
	\\Nella conversazione è presente una bubble \glossario{To-do List} con al suo interno un form per l'inserimento delle informazioni necessarie al completamento della creazione della to do list.
\end{itemize}
...
\subsubsection{UC2.2 Aggiungere elemento alla \glossario{To-do List}} \label{UC2.2}

\begin{itemize}
	\item \textbf{Attori:}
	\\Utente di \glossario{Rocket.Chat} in possesso di monolith.
	\item \textbf{Scopo e descrizione:} 
	\\Un utente inserisce un nuovo elemento alla \glossario{To-do List}.
	\item \textbf{Precondizioni:}
	\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Post-condizione:}
	\\La \glossario{To-do List} avrà il nuovo elemento aggiunto.
\end{itemize}
...
\begin{itemize}
	...
	\\Utente di Rocket.Chat in possesso di monolith.
	\item \textbf{Scopo e descrizione:} 
	\\L’utente seleziona l’opzione per inserire un nuovo elemento alla \glossario{To-do List}.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere ricevuto una bubble di \glossario{To-do List}.
	\end{itemize}
...
\begin{itemize}
	...
	\\Utente di Rocket.Chat in possesso di monolith.
	\item \textbf{Scopo e descrizione:} 
	\\Visualizzazione del form di aggiunta delle informazioni relative al nuovo elemento della \glossario{To-do List}.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere ricevuto una bubble di \glossario{To-do List};
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\L’utilizzatore del metodo scrive il testo da inserire nel nuovo elemento e lo aggiunge alla \glossario{To-do List}.
	\item \textbf{Post-condizione:}
	\\Il nuovo elemento è aggiunto alla bubble \glossario{To-do List}.
\end{itemize}
...
\begin{itemize}
	...
	\\Utente di Rocket.Chat in possesso di monolith.
	\item \textbf{Scopo e descrizione:} 
	\\L’utente inserisce le informazioni necessarie ad aggiungere un elemento alla \glossario{To-do List}.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere ricevuto una bubble di \glossario{To-do List};
	...
	\item \textbf{Post-condizione:}
	\\La \glossario{To-do List} ha tutte le informazioni necessarie ad aggiungere il nuovo elemento.
\end{itemize}
...
\begin{itemize}
	...
	\\Utente di Rocket.Chat in possesso di monolith.
	\item \textbf{Scopo e descrizione:} 
	\\Un utente conferma l’inserimento del nuovo elemento alla \glossario{To-do List}.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere ricevuto una bubble di \glossario{To-do List};
	...
	\item \textbf{Post-condizione:}
	\\L’elemento è stato aggiunto alla \glossario{To-do List}.
\end{itemize}

\subsubsection{UC2.3 Indicare come completati gli elementi della \glossario{To-do List}} \label{UC2.3}

\begin{itemize}
	\item \textbf{Attori:}
	\\Utente di Rocket.Chat in possesso di monolith che abbia ricevuto come messaggio una bubble \glossario{To-do List}.
	\item \textbf{Scopo e descrizione:} 
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\L’utilizzatore del metodo seleziona un elemento della \glossario{To-do List} e lo indica come completato. 
	\item \textbf{Post-condizione:}
	\\L’elemento della \glossario{To-do List} è settato come completato.
\end{itemize}
...
\begin{itemize}
	\item \textbf{Attori:}
	\\Utente di Rocket.Chat in possesso di monolith che ha creato la \glossario{To-do List}.
	\item \textbf{Scopo e descrizione:} 
...
\\L'ordine così effettuato verrà trasmesso alla cucina del locale tramite bubble “\glossario{To-do List}”, sotto forma di casella aggiunta automaticamente in fondo alla lista, il cuoco una volta completato l'ordine avrà facoltà di segnare completata l’ordinazione dalla lista.
...
\begin{itemize}
	...
	\item Responsabile Acquisti: addetto a rifornire il magazzino sulla base degli ingredienti consumati dal cuoco in base a quanto gli è notificato dalla sua \glossario{To-do List} nella bubble;
...
\begin{itemize}
	...
	\\Direttore.
	\item \textbf{Scopo e descrizione:} 
	\\Lo scopo di questa funzione è permettere al direttore di cancellare ordini dalla \glossario{To-do List} del cuoco.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere \glossario{Rocket.Chat};
		\item Avere la bubble del ristorante selezionato;
	...
	\end{itemize}
	\item \textbf{Post-condizione:}
	\\L’ordine è stato cancellato dalla \glossario{To-do List} del cuoco.
\end{itemize}
...
\begin{itemize}
	...
	\\Direttore.
	\item \textbf{Scopo e descrizione:} 
	\\Lo scopo di questa funzione è permettere al direttore di selezionare ordini da cancellare dalla \glossario{To-do List} del cuoco.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere \glossario{Rocket.Chat};
		\item Avere la bubble del ristorante selezionato;
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\Il direttore sceglie l’ordine da eliminare dalla \glossario{To-do List} del cuoco.
	\item \textbf{Post-condizione:}
...
\begin{itemize}
	...
	\\Direttore.
	\item \textbf{Scopo e descrizione:} 
	\\Lo scopo di questa funzione è permettere al direttore di aggiungere ordini alla \glossario{To-do List} del responsabile acquisti.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere \glossario{Rocket.Chat};
		\item Avere la bubble del ristorante selezionato;
	...
	\end{itemize}
	\item \textbf{Post-condizione:}
	\\Il direttore ha aggiunto gli elementi desiderati alla \glossario{To-do List} del responsabile acquisti.
\end{itemize}
...
\begin{itemize}
	...
	\\Direttore.
	\item \textbf{Scopo e descrizione:} 
	\\Lo scopo di questa funzione è permettere al direttore di selezionare l’opzione per aggiungere ordini alla \glossario{To-do List} del responsabile acquisti.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere \glossario{Rocket.Chat};
		\item Avere la bubble del ristorante selezionato;
...
\begin{itemize}
	...
	\\Direttore.
	\item \textbf{Scopo e descrizione:} 
	\\Lo scopo di questa funzione è permettere al direttore di aggiungere informazioni all’ordine da aggiungere alla \glossario{To-do List} del responsabile acquisti.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere \glossario{Rocket.Chat};
		\item Avere la bubble del ristorante selezionato;
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\Il direttore aggiunge gli elementi desiderati all’ordine per la \glossario{To-do List} del responsabile acquisti.
	\item \textbf{Post-condizione:}
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\Il database deve essere aggiornato con gli elementi aggiunti dal direttore alla \glossario{To-do List} del responsabile acquisti.
	\item \textbf{Post-condizione:}
...
\begin{itemize}
	...
	\\Direttore.
	\item \textbf{Scopo e descrizione:} 
	\\Lo scopo di questa funzione è permettere al direttore di eliminare ordini dalla \glossario{To-do List} del responsabile acquisti.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere \glossario{Rocket.Chat};
		\item Avere la bubble del ristorante selezionato;
	...
	\end{itemize}
	\item \textbf{Post-condizione:}
	\\Il direttore ha eliminato gli elementi desiderati dalla \glossario{To-do List} del responsabile acquisti.
\end{itemize}
...
\begin{itemize}
	...
	\\Direttore.
	\item \textbf{Scopo e descrizione:} 
	\\Lo scopo di questa funzione è permettere al direttore di selezionare l’opzione per rimuovere ordini dalla \glossario{To-do List} del responsabile acquisti.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere \glossario{Rocket.Chat};
		\item Avere la bubble del ristorante selezionato;
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\Il database deve essere aggiornato con gli elementi rimossi dal direttore alla \glossario{To-do List} del responsabile acquisti.
	\item \textbf{Post-condizione:}
