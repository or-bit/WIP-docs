...
\UC{Istanziazione della \glossario{bubble generica}}{UC1.35}
...
\begin{itemize}
	...
	\\L'utilizzatore del framework può istanziare il contenitore bubble generica, il quale funge da contenitore dei vari elementi di input, output e di logica specificati all'interno del framework.
...
\UC{Connessione a database \glossario{MongoDB}}{UC1.00}
...
\UC{Lettura da database MongoDB}{UC1.01}

\begin{figure}[H]
	\centering
	\includegraphics[width=15cm]{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_01.png}
	\caption{\UCCaption{} Lettura da database MongoDB}
\end{figure}
...
\UC{Scrittura su database MongoDB}{UC1.02}

\begin{figure}[H]
	\centering
	\includegraphics[width=15cm]{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_02.png}
	\caption{\UCCaption{} Scrittura su database MongoDB}
\end{figure}
...
\begin{itemize}
	\item Avere già istanziato una bubble generica;
	\item La bubble è connessa al database MongoDB;
...
\UCC{Rimozione di un elemento presente}{UC1.03.1}
...
\begin{itemize}
	...
	\\L'elemento non è presente nella bubble \ref{UC1.03.2}.
	\item \textbf{Post-condizione:}
	\\La bubble non contiene l'elemento indicato da rimuovere.
\end{itemize}

\UCC{Rimozione di un elemento non presente}{UC1.03.2}
...
\UC{Aggiunta di un elemento}{UC1.04}
...
\begin{itemize}
	...
	\\Utilizzatore del framework.
	\item \textbf{Scopo e descrizione:} 
	\\L'utilizzatore del framework può inserire all'interno della bubble una \glossario{label}.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una bubble generica;
		\item Avere un testo da visualizzare.
...
\UCF{Grafico a istogramma}{UC1.29}
...
\begin{itemize}
	...
	\\Utilizzatore del framework.
	\item \textbf{Scopo e descrizione:} 
	\\L'utilizzatore del framework può inserire un elemento \glossario{checkbox} all'interno della bubble specificando la variabile della bubble memory a cui l'elemento è assegnato.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una bubble generica.
	\end{itemize}
...
\begin{itemize}
	...
	\\Utilizzatore del framework.
	\item \textbf{Scopo e descrizione:} 
	\\L'utilizzatore del framework può inserire un elemento \glossario{bottone radio} di scelta di un elemento tra molti all'interno della bubble, specificando la variabile della bubble memory a cui la scelta è assegnata.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una bubble generica.
	\end{itemize}
...
\begin{itemize}
	...
	\\Utilizzatore del framework.
	\item \textbf{Scopo e descrizione:} 
	\\L'utilizzatore del framework può inserire un elemento \glossario{bottone} all'interno della bubble specificando la funzione che verrà eseguita alla pressione del bottone da parte dell'utente.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una bubble generica;
	...
	\item \textbf{Post-condizione:}
	\\Nella bubble è presente il bottone. Alla pressione da parte dell'utente del bottone della bubble la funzione di \glossario{callback} specificata verrà eseguita.
\end{itemize}
...
\begin{itemize}
	...
	\\Utilizzatore del framework.
	\item \textbf{Scopo e descrizione:} 
	\\L'utilizzatore del framework può richiedere un input testuale \glossario{TextEdit}.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una bubble generica.
	\end{itemize}
...
\UCC{Modifica di un elemento presente}{UC1.05.1}
...
\UCC{Modifica di un elemento non presente}{UC1.05.2}
...
\UC{Limite interazioni per persona}{UC1.08}
...
\UC{Dimensione massima del file}{UC1.11}
...
\UC{Esecuzione in orario specificato}{UC1.16}
...
\UC{Creazione notifica statica}{UC1.17}
...
\UC{Visualizza notifica statica}{UC1.18}

\begin{figure}[H]
	\centering
	\includegraphics[width=15cm]{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_18.png}
	\caption{\UCCaption{} Visualizza notifica statica}
\end{figure}
...
\UC{Mostra elemento grafico}{UC1.21}
...
\begin{itemize}
	...
	\\Utilizzatore del framework.
	\item \textbf{Scopo e descrizione:} 
	\\L'utilizzatore del framework potrà mostrare un \glossario{elemento grafico}.
	\item \textbf{Precondizioni:}
	\begin{itemize}
		\item Avere già istanziato una bubble generica;
...
\UC{Nascondi elemento grafico}{UC1.22}
...
\UC{Imposta posizione elemento grafico}{UC1.23}

\begin{figure}[H]
	\centering
	\includegraphics[width=15cm]{../../documenti/AnalisiDeiRequisiti/Diagrammi_img/uc1_23.png}
	\caption{\UCCaption{} Imposta posizione elemento grafico}
\end{figure}
...
\begin{itemize}
	...
	\item \textbf{Flusso principale degli eventi:}
	\begin{itemize}
		\item Vengono recuperate dalla memoria della bubble le informazioni sull'ordine \hyperref[UC3.4.1]{(UC3.4.1)};
		\item Vengono recuperate le informazioni sui dati personali del Cliente dalla memoria della bubble \hyperref[UC3.4.2]{(UC3.4.2)};
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
	\\Il Direttore seleziona dalla lista visualizzata in \hyperref[UC3.13.1]{(UC3.13.1)} gli elementi del menù che desidera rimuovere da esso.
	\item \textbf{Post-condizione:}
...
\begin{itemize}
	...
	\item \textbf{Flusso principale degli eventi:}
	\begin{itemize}
		\item Il Direttore seleziona l'opzione per aggiungere un elemento \hyperref[UC3.13.4.1]{(UC3.13.4.1)};
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item L'utente Direttore seleziona \virgolette{Aggiungi ordine} \hyperref[UC3.14.3]{(UC3.14.3)};
		\item L'utente Direttore inserisce le informazioni sull'ordine da aggiungere \hyperref[UC3.14.4]{(UC3.14.4)};
		\item L'utente Direttore seleziona \virgolette{Conferma} \hyperref[UC3.14.5]{(UC3.14.5)};
