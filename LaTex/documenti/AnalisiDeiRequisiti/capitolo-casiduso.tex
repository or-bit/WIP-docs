...
\subsubsection[Istanziazione della bubble generica]{\UC{} Istanziazione della bubble generica} \label{UC1.35}
...
\subsubsection[Connessione a database \glossario{MongoDB}]{\UC{} Connessione a database MongoDB} \label{UC1.00}
...
\subsubsection[Lettura da database MongoDB]{\UC{} Lettura da database MongoDB} \label{UC1.01}
...
\subsubsection[Scrittura su database MongoDB]{\UC{} Scrittura su database MongoDB} \label{UC1.02}
...
\subsubsection[Rimozione di un elemento]{\UCFiglio{} Rimozione di un elemento} \label{UC1.03.1}
...
\begin{itemize}
	...
	\begin{itemize}
		\item Avere già istanziato una bubble generica;
		\item All'interno della bubble sono presenti degli \glossario{elementi}.
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
...
\begin{itemize}
	...
	\item \textbf{Post-condizione:}
	\\Nella bubble è presente il bottone. Alla pressione da parte dell'utente del bottone della bubble la funzione di callback specificata verrà eseguita.
\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		\item Essere utenti di Rocket.Chat;
		\item Avere \ProjectName{} installato;
		\item Aver invocato il comando di creazione della to-do list \hyperref[UC2.1.1]{UC2.1.1}.
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
...
\begin{itemize}
	...
	\begin{itemize}
		\item Avere ricevuto una bubble To-do list;
		\item Aver inserito le informazioni per il nuovo elemento secondo \hyperref[UC2.2.3]{UC2.2.3}.
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
...
\begin{itemize}
	...
	\begin{itemize}
		\item Avere ricevuto una bubble To-do list;
		\item Essere entrati nell'opzione \virgolette{aggiungi modifica} della propria bubble secondo \hyperref[UC2.4.1]{UC2.4.1}.
	\end{itemize}
	\item \textbf{Flusso principale degli eventi:}
