...
\begin{longtable}{|P{1.5cm}|P{2.5cm}|P{6.5cm}|P{2.5cm}|}
	...
	\hline \RequisitoOpF\label{L40} & Opzionale & Il \glossario{framework} offre la possibilità di stabilire una funzionalità di output \glossario{PDF} per la \glossario{bubble} & \hyperref[UC1.20.1]{UC1.20.1} \\	
...
\begin{longtable}{|P{1.5cm}|P{2.5cm}|P{6.5cm}|P{2.5cm}|}
	...
	\hline \RequisitoObF\label{L19} & Obbligatorio & La \glossario{bubble} \glossario{To-do list} offre la funzionalità di segnare come completati elementi della lista & \hyperref[UC2.3]{UC2.3} \\
	\hline \RequisitoObF\label{L20} & Obbligatorio & La \glossario{To-do list} permette di settare un remind come notifica statica & \hyperref[UC2.4]{UC2.4} \\
	\hline
