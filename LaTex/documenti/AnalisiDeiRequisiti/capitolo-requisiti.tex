...
\begin{longtable}{|P{1.5cm}|P{2.5cm}|P{6.5cm}|P{2.5cm}|}
	...
	\hline \RequisitoDF\ref{L100} & Desiderabile & La bubble mostra all'utente un resoconto dell'ordine prima di confermarlo definitivamente & \ref{UC3.3.4} \\
...
\begin{longtable}{|P{6cm}|P{6cm}|}
	...
	\hline \ref{L41} & \ref{UC1.32} \\
 	\hline \ref{L84} & \ref{UC1.31} \\
 	\hline \ref{L84} & \ref{UC1.30} \\
