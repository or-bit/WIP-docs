...
\begin{longtable}{|P{1.5cm}|P{2.5cm}|P{6.5cm}|P{2.5cm}|}
	...
	\hline \RequisitoObF\label{L53} & Obbligatorio & Il framework offre la possibilità di modificare elementi della bubble. & \ref{UC1.05.1} \\
	\hline \RequisitoObF\label{L54} & Obbligatorio & Il framework offre la possibilità di rimuovere elementi dalla bubble. & \ref{UC1.03.1} \\
...
\begin{longtable}{|P{6cm}|P{6cm}|}
	...
	\hline Capitolato & \RequisitoObVRef{L1} \linebreak \RequisitoObVRef{L2} \linebreak \RequisitoOpF{L3} \linebreak \RequisitoOpF{L4} \linebreak \RequisitoObVRef{L54} \\
	...
	\hline \ref{UC1.03.1} & \RequisitoObFRef{L54} \\
	\hline \ref{UC1.04} & \RequisitoObFRef{L11} \\
	\hline \ref{UC1.05.1} & \RequisitoObFRef{L53} \\
	\hline \ref{UC1.06.1} & \RequisitoObVRef{L54} \\
	...
	\hline \ref{UC3.10.2} & \RequisitoObFRef{L21} \\
...
\begin{longtable}{|P{6cm}|P{6cm}|}
	...
	\hline \RequisitoObFRef{L53} & \ref{UC1.05.1} \\
	\hline \RequisitoObFRef{L54} & \ref{UC1.03.1} \\
