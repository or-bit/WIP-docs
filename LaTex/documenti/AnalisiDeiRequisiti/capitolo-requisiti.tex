...
\begin{longtable}{|P{1.5cm}|P{2.5cm}|P{6.5cm}|P{2.5cm}|}
	...
	\hline \RequisitoOpF\label{L94} & Opzionale & Il framework restituisce un messaggio di errore per operazioni non permesse & \ref{1.00.2} \ref{UC1.03.2} \ref{UC1.05.2} \ref{UC1.06.2} \ref{UC1.07.2} \ref{UC1.15.2} \ref{UC1.20.2} \ref{UC1.24.2} \\
