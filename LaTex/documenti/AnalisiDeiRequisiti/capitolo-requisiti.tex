...
\begin{longtable}{|P{1.5cm}|P{2.5cm}|P{6.5cm}|P{2.5cm}|}
	...
	\hline \RequisitoOpF\label{L78} & Opzionale & Il framework offre la possibilità di creare un elemento radio button & \ref{UC1.31} \\
	\hline \RequisitoOpF\label{L79} & Opzionale & Il framework offre la possibilità di creare un elemento checkbox & \ref{UC1.30} \\
...
\begin{longtable}{|P{6cm}|P{6cm}|}
	...
	\hline \ref{UC1.30} & \RequisitoOpFRef{L79} \\
	\hline \ref{UC1.31} & \RequisitoOpFRef{L78} \\
...
\begin{longtable}{|P{6cm}|P{6cm}|}
	...
	\hline \RequisitoOpFRef{L78} & \ref{UC1.31} \\
	\hline \RequisitoOpFRef{L79} & \ref{UC1.30} \\
