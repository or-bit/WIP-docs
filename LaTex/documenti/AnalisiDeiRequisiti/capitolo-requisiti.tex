...
\begin{longtable}{|P{1.5cm}|P{2.5cm}|P{6.5cm}|P{2.5cm}|}
	...
	\hline \RequisitoObF\label{L69} & Obbligatorio & La quantità di default per un cibo selezionato è 1 & \ref{UC3.3} \\
	\hline \RequisitoObF\label{L70} & Obbligatorio & Non può essere incrementata la quantità per un cibo non selezionato & \ref{UC3.3} \\
