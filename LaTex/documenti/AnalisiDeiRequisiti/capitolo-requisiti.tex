\section{Requisiti}
Vengono ora presentati i requisiti emersi durante l'analisi del capitolato e di ogni \glossario{caso d'uso} e i requisiti discussi nelle riunioni interne e con il Proponente.
...
\begin{longtable}{|P{1.5cm}|P{2.5cm}|P{6.5cm}|P{2.5cm}|}
	...
	\hline \RequisitoObV \label{L2} & Obbligatorio & Il \glossario{framework} è sviluppato come pachetto per \glossario{Rocket.Chat} & Capitolato \\
	\hline \RequisitoObV\label{L3} & Obbligatorio & Viene sviluppata una \glossario{bubble} di tipo to-do list. & Capitolato \\
...
\begin{longtable}{|P{1.5cm}|P{2.5cm}|P{6.5cm}|P{2.5cm}|}
	...
	\hline \RequisitoObF\label{L9} & Obbligatorio & Il \glossario{framework} offre funzionalità di settaggio di durata delle \glossario{bubble}. & \hyperref[UC1.13]{UC1.13} \\
	\hline \RequisitoObF\label{L10} & Obbligatorio & Il \glossario{framework} offre funzionalità di terminazione \glossario{bubble}. & \hyperref[UC1.19]{UC1.19} \\
	...
	\hline \RequisitoObF\label{L15} & Obbligatorio & Il \glossario{framework} mette a disposizione funzionalità di creazione di notifica per le \glossario{bubble} & \hyperref[UC1.18]{UC1.18} \\
	...
	\hline \RequisitoObF\label{L33} & Obbligatorio & L'utilizzatore del \glossario{framework} può inserire all'interno della \glossario{bubble} un TextView & \hyperref[UC1.26]{UC1.26} \\
	\hline \RequisitoObF\label{L34} & Obbligatorio & L'utilizzatore del \glossario{framework} può inserire all'interno della \glossario{bubble} un TextView editabile & \hyperref[UC1.33]{UC1.33} \\
	...
	\hline \RequisitoOpF\label{L38} & Opzionale & Il \glossario{framework} offre la possibilità di stabilire una funzionalità di richiesta di file in input per la \glossario{bubble} & \hyperref[UC1.34]{UC1.34} \\
	\hline \RequisitoOpF\label{L39} & Opzionale & Il \glossario{framework} offre la possibilità di stabilire una funzionalità di output per la \glossario{bubble} & \hyperref[UC1.24.1]{UC1.24.1} \\
	\hline \RequisitoOpF\label{L40} & Opzionale & Il \glossario{framework} offre la possibilità di stabilire una funzionalità di output pdf per la \glossario{bubble} & \hyperref[UC1.20.1]{UC1.20.1} \\	
	\hline \RequisitoOpF\label{L41} & Opzionale & Il \glossario{framework} offre la possibilità di inserire bottoni quali radio buttons e checkbox nella \glossario{bubble} & \hyperref[UC1.30]{UC1.30} \linebreak \hyperref[UC1.31]{UC1.31} \linebreak \hyperref[UC1.32]{UC1.32} \\
	...
	\hline \RequisitoOpF\label{L46} & Opzionale & Il \glossario{framework} offre metodi per la creazione di grafici a torta ed istogrammi
	 ...
	 \hline \RequisitoOpF\label{L47} & Opzionale & Possibilità di impostare un numero massimo di interazioni per ogni singolo utente di Rocket.Chat con la \glossario{bubble}. & \hyperref[UC1.08]{UC1.08} \\
...
\begin{longtable}{|P{1.5cm}|P{2.5cm}|P{6.5cm}|P{2.5cm}|}
	\hline \textbf{Codice} & \textbf{Categoria} & \textbf{Descrizione} & \textbf{Fonti} \\
	\hline \RequisitoObF\label{L17} & Obbligatorio & La \glossario{bubble} To-do list permette all'utente la creazione di liste & \hyperref[UC2.1]{UC2.1} \\
	\hline \RequisitoObF\label{L18} & Obbligatorio & La \glossario{bubble} To-do list offre la funzionalità di inserimento di nuovi elementi nella lista & \hyperref[UC2.2]{UC2.2} \\
	\hline \RequisitoObF\label{L19} & Obbligatorio & La \glossario{bubble} To-do list offre la funzionalità di segnare come completati elementi della lista & \hyperref[UC2.3]{UC2.3} \\
