...
\begin{longtable}{|P{1.5cm}|P{2.5cm}|P{6.5cm}|P{2.5cm}|}
	...
	\hline \RequisitoOpF\label{L31} & Opzionale & L'utente Direttore può visualizzare la lista degli acquisti da effettuare. & \ref{UC3.14.2} \ref{UC3.15.2} \\
	...
	\hline \RequisitoOpF\label{L53} & Opzionale & L'utente Direttore può aggiungere ingredienti alla lista degli acquisti da effettuare. & \ref{UC3.14}\\
	 \hline \RequisitoOpF\label{L65} & Opzionale & L'utente Direttore può eliminare ingredienti dalla lista degli acquisti da effettuare. & \ref{UC3.15} \\	 
