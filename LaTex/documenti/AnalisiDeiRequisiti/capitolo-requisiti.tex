...
\begin{longtable}{|P{6cm}|P{6cm}|}
	...
	\hline Capitolato & R1 \linebreak R2 \linebreak R3 \linebreak R4 \\
...
\begin{longtable}{|P{6cm}|P{6cm}|}
	...
	\hline R3 & Capitolato \\
	\hline R4 & Capitolato \\
	\hline R5 & Verbale x.x.x \linebreak \hyperref[UC1.06.1]{UC1.06.1}  \\	
	\hline R6 & \hyperref[UC1.35]{UC1.35} \\
	\hline R7 & \hyperref[UC1.36]{UC1.36} \\
	\hline R8 & verbale x.x.x \linebreak \hyperref[UC1.00]{UC1.00} \linebreak \hyperref[UC1.01]{UC1.01} \linebreak \hyperref[UC1.02]{UC1.02} \\
