...
\subsubparagraph{TodoList\-::View\-::ListItemView}\label{todo-item}\mbox{}\\
\textbf{Descrizione:}\\
...
\begin{samepage}
	\subsubparagraph{TodoList\-::Controller\-::List\-Items\-::ListItemController}\label{todo-controller}\mbox{}\\
	\nopagebreak
	\begin{figure}[H]
		\centering
