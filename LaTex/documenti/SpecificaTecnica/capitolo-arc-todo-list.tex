...
\subsubparagraph{TodoList\-::Model\-::Data\-Checker}\label{todo-gateway}\mbox{}\\
\textbf{Descrizione:}\\
La classe DataChecker verifica la correttezza dei dati rispetto ad uno schema dato.\\
\textbf{Utilizzo:}\\
Questa classe permette di verificare l'integrità dei dati inviati dall'utente rispetto ad uno schema dato.

\subsubparagraph{TodoList\-::Model\-::ListItems}
\begin{figure}[H]
	\centering
