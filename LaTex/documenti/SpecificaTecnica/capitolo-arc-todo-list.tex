...
\subsection{To-do List} \label{todo-list}
...
\subparagraph{TodoList\-::Model\-::List\-Items\-::List\-Item}\label{todo-item}\mbox{}\\
\textbf{Descrizione:}\\
...
\subparagraph{TodoList\-::Model\-::List\-Items\-::List\-Item\-Container}\label{todo-container}\mbox{}\\
\textbf{Descrizione:}\\
...
\subparagraph{TodoList\-::Model\-::Db\-Gateway\-::Data\-Checker}\label{todo-gateway}\mbox{}\\
\textbf{Descrizione:}\\
...
\begin{samepage}
	\subparagraph{TodoList\-::Controller\-::Todo\-Controller}\label{todo-controller}\mbox{}\\
	\nopagebreak
	\begin{figure}[H]
		\centering
