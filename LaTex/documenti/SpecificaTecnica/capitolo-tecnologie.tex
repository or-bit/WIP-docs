...
\begin{itemize}
	...
	\item \textbf{Classi:} ECMAScript 6 prevede inoltre di aggiungere zucchero sintattico al pattern \glossario{Object-Oriented} di JavaScript permettendo la dichiarazione di classi, ereditarietà, metodi statici e di istanza. Di conseguenza il codice prodotto è più semplice da comparare con quello di un qualsiasi altro  linguaggio orientato agli oggetti.
\end{itemize}
