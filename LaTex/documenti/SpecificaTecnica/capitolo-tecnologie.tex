...
Bootstrap è un framework per la progettazione della parte front-end di siti e applicazioni web. Questo framework permette di migliorare la qualità del codice utilizzando \glossario{template} HTML e CSS di comprovata efficienza ed efficacia. Boostrap garantisce un notevole supporto allo sviluppo del front-end di \ProjectName{} grazie alla presenza di numerose componenti responsive e classi css già configurate.
