...
Il linguaggio JavaScript da utilizzare per il progetto deve implementare le specifiche \glossario{ECMAScript} 2015 (o ECMAScript 6), ossia la versione stabile più aggiornata dello standard ECMAScript. 
...
\begin{itemize}
	...
	\item \textbf{Classi:} ECMAScript 2015 prevede inoltre di aggiungere zucchero sintattico al pattern \glossario{Object-Oriented} di JavaScript permettendo la dichiarazione di classi, ereditarietà, metodi statici e di istanza. Di conseguenza il codice prodotto è più semplice da comparare con quello di un qualsiasi altro linguaggio orientato agli oggetti.
\end{itemize}
