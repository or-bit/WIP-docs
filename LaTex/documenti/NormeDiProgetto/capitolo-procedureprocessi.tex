...
È compito degli \Analisti\space controllare la corrispondenza tra i requisiti e le loro fonti (capitolato, casi d'uso, verbali di riunioni).

\subsection{Progettazione}
\subsubsection{Specifica Tecnica}
È compito dei \Progettisti\space descrivere la \PA\space ad alto livello del prodotto nella \SpecificaTecnica.
