...
Il documento prodotto viene conservato nel \glossario{repository} \url{link repo}, condiviso tra tutti membri del progetto.
...
\paragraph{Convocazione delle riunioni}\mbox{}\\
Secondo quanto indicato dal \Proponente, per comunicare con il \Proponente va utilizzato un apposito canale \glossario{Slack}, mentre per il Committente va utilizzato l'indirizzo \email{} \href{mailto:\GroupEmail}{\GroupEmail}.\\
...
Questo documento deve essere redatto utilizzando l'apposito template \glossario{\LaTeX{}} (file: “template_verbale.tex”).
