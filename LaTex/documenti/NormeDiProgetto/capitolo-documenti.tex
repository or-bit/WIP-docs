...
\begin{itemize}
	...
	\item \textbf{nome del gruppo}: per riferirsi al nome del gruppo è necessario utilizzare il comando \LaTeX{} \textbackslash{\texttt{GroupName}} affinché risulti scritto correttamente secondo quanto quanto riportato in \sezione{sec:lettere_maiuscole};
...
I documenti interni sono rivolti ai componenti del gruppo e sono redatti in lingua italiana. Fanno parte di questa categoria \NormeDiProgetto, \StudioDiFattibilita{} e eventuali verbali interni.\footnote[1]{Si rimanda alla \sezione{sec:verbale_riunioni_interne} per la definizione di questi ultimi.}
