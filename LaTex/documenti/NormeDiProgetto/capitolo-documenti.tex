...
Per convenzione le immagini vanno salvate in formato vettoriale \glossario{SVG} quando possibile, altrimenti deve essere utilizzato il formato ad alta risoluzione \glossario{PNG}.
...
\begin{itemize}
	...
	\end{enumerate} 
\end{itemize}
Il raggiungimento di \glossario{milestone} interne non implica l'approvazione finale del documento ma solo verifiche dello stesso.
