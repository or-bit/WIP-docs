...
\begin{center}
	...
	\captionof{figure}{Procedura di creazione di un \glossario{Milestone} parte 2}
\end{center}
...
\begin{center}
	...
	\captionof{figure}{Procedura di editing di un evento parte 1}
\end{center}

\begin{center}
	\includegraphics[width=15cm]{../../documenti/NormeDiProgetto/DiagrammiProcedure/EditEventi2.png}
	\captionof{figure}{Procedura di editing di un evento - Sezione della modifica dei dettagli}
\end{center}

\begin{center}
	\includegraphics[width=15cm]{../../documenti/NormeDiProgetto/DiagrammiProcedure/EditEventi3.png}
	\captionof{figure}{Procedura di editing di un evento - Sezione modifica impostazioni dei partecipanti}
\end{center}

\begin{center}
	\includegraphics[width=15cm]{../../documenti/NormeDiProgetto/DiagrammiProcedure/EditEventi4.png}
	\captionof{figure}{Procedura di editing di un evento - Modifica reminder }
\end{center}

\newpage
\paragraph{Procedura di editing di un Task:}
