...
\newcommand{\glossario}[1]{#1\ped{\ped{G}}}
...
In secondo luogo, utilizzare il \glossario{framework} prodotto per fornire esempi significativi delle suddette \glossario{bubble}.
}

\newcommand{\GlossarioIntroduzione}{
Insieme al progetto il gruppo fornirà anche un glossario nel quale saranno raccolti i termini tecnici, gli acronimi e le parole che necessitano di chiarimenti, che verranno utilizzati nella documentazione.\\
