...
Lo scopo di questo progetto è sviluppare un framework volto alla costruzione di bubble interattive, per aggiungere funzionalità al programma di comunicazione Rocket.Chat\texttrademark\footnote{\url{https://rocket.chat/}}.
